...
{
  &quot;type&quot;: &quot;info&quot;,
  &quot;title&quot;: &quot;Applying a ruleset to an event&quot;,
  &quot;body&quot;: &quot;This article describes the call to add rulesets to a chart. To apply one of those rulesets to an event, use the [create event](/docs/api-create-an-event) or [update event](/docs/api-update-an-event) call.&quot;
}
[/block]
